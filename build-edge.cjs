#!/usr/bin/env node
// build-edge.cjs — 基于 EdgeOne Pages 官方 KV 规范重构
...
const edgeCode = `// Auto-generated by build-edge.cjs
...
console.log("✅ build-edge.cjs updated with strict official KV binding support.");
